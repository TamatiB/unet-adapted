...
class myUnet(object):
	...
	def load_data(self):
		...
		print("Loaded " + str(len(imgs_train)) + " training images")
		print("Loaded " + str(len(imgs_test)) + " test images")
		return imgs_train, imgs_mask_train, imgs_test

	def get_unet(self):

		input_imgs = Input((self.img_rows, self.img_cols,1))

		'''
		unet with crop(because padding = valid)

		conv1 = Conv2D(64, 3, activation = 'relu', padding = 'valid', kernel_initializer = 'he_normal')(input_imgs)
		...
		conv1 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(input_imgs)
		print ("conv1 shape:",conv1.shape)
		...
		model = Model(inputs = input_imgs, outputs = conv10)
